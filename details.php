...
$teacherdetail = mysqli_query($connect, $sql);
    $path = "administrator/teacherimage/";

    while ($runrows = mysqli_fetch_assoc($teacherdetail))
    {
        ...
        {
            $result2 = "<br/><a href =viewComment.php?id=$id >See all the feedback for this teacher. </a>
        
                        <br/><a href =seeVideo.php?id=$id >See all this teacher videos! </a>
        
                        <br/><a href =relation.php?id=$id >I want to be taught by this teacher! </a>
        </table>";
        }
        else
        {
...
?>
                ...
                <div class="width75 floatRight"> 
                    ...
                    <div class="gradient"> <a name="fluidity"></a>
                        <h1>Details of the Teacher.</h1>
                        <p>
<?php
echo $result;
echo "<br/><b>Category of Expertise:</b>";
$sql2 = "SELECT c.category_type FROM category c, resolvecategory rc WHERE rc.category_id = c.category_id AND rc.teacher_id =  '$id'";
          $catresult = mysqli_query($connect, $sql2);
          while ($runrows2 = mysqli_fetch_assoc($catresult))
          {
              $category = $runrows2['category_type'];
