...
if (isset($_SESSION['email_add']) || isset($_COOKIE['email_add']))
{
    ...
    {
        $USERID = $runrows['registeruser_id'];
    }


    $sql2 = "SELECT t.teacher_id, t.first_name, t.last_name, r.status FROM teacher t, registereduser rs, relation r WHERE t.teacher_id = r.teacher_id AND rs.registeruser_id = r.registeruser_id AND r.registeruser_id = '$USERID'";
...
// Please Login Message.
                        echo "<h3>" . $pleaselogin . "</h3>";
                        ?>

                        <p>
                            <?php
                            $headertable = "<table border= '1' cellpadding='4' cellspacing='0'>
                                            <tr>
                                            <th>First Name</th>
                                            <th>Last Name</th>
                                            <th>Status</th>
                            ...
                            {
                                $teacherFirstName = $runrows['first_name'];
                                $teacherLastName = $runrows['last_name'];
                                $status = $runrows['status'];
                                $teacherID = $runrows['teacher_id'];

                                $result = " <tr>
                                            <td>$teacherFirstName</td>
                                            <td>$teacherLastName</td>
                                            <td>$status</td>
                                            <td><a href =comment.php?id=$teacherID >Comment and rate on this teacher.</a></td>
                                            <td><a href =details.php?id=$teacherID >More details of the teacher.</a></td>
                                            <td><a href =seeVideo.php?id=$teacherID >Video of the teacher.</a></td>
                                            </tr>
                            ...
                            <p>
                                ...
                                <br/>
                                Legend:<br/>
                                Pending - Waiting for the teacher to approve. <br/>
                                Active - You are already associated with the teacher. <br/>
                                Inactive - Your arrangement is closed by the teacher.
                            </p>
                        </p>
                    </div>
