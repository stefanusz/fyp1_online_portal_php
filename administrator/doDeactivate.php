...
if ($_SESSION['role'] == 'admin' || $_COOKIE['role'] == 'admin')
{
    ...
    mysqli_query($connect, "UPDATE `teacher` SET status = 'inactive' WHERE email_add = '$email_add' ") or die(mysql_error());
    mysqli_query($connect, "UPDATE  `registereduser`  SET `status` = 'inactive' WHERE email_add = '$email_add' ") or die(mysql_error());


    $deactive = "You have successfully Deactivate the user";
}
else
{
