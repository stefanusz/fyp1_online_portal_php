...
if ($_SESSION['role'] == 'teacher' || $_COOKIE['role'] == 'teacher')
{
    ...
    mysqli_query($connect, "UPDATE `relation` SET status = 'inactive' WHERE registeruser_id = '$REGISTERUSER_ID' ") or die(mysql_error());



    $deactive = "You have successfully Deactivate the student";
}
else
{
