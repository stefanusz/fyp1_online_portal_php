...
// to let the user(admin) do a search from the whole database regarding the users.
if ($_SESSION['role'] == 'teacher' || $_COOKIE['role'] == 'teacher')
{
    $searchform = "<form action=domyStudent.php method=GET>
			 <select name=search>
            ...
            <div id="page"> 
                ...
                <div class="width75 floatRight"> 
                    ...
                    <div class="gradient"> <a name="fluidity"></a>
                        ...
                        <h3>Search according to the Students status from the drop down below.</h3>
                        <br />
                        <table>
