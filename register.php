...
// To check if the user is a registered user or not.
if (isset($_SESSION['email_add']) || isset($_COOKIE['email_add']))
{
    $login = "You are already log-in. Click <a href='dologout.php' title=here>here</a> to log out. ";
}
else
{
    $form2 = "<h2><a href=registerTeacher.php title=Register as a teacher!>Register as a Teacher.</a></h2><br/><br/>
				<h2><a href=registerStudent.php title=Register as a student!>Register as a Student.</a></h2>";
}
?>
...
?>
                ...
                <div class="width75 floatRight"> 
                    ...
                    <div class="gradient"> <a name="fluidity"></a>
                        ...
                        <p> Please click on either one of them accordingly. We will verified your account. </p>
                        <p> <?php echo $login ?> <?php echo $form2 ?> </p>
                    </div>
