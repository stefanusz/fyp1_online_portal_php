    ...
    if ($_SESSION['role'] == 'teacher')
    {
                ...
                && ($_FILES["uploadedfile"]["size"] < 50000000))
        {
            ...
            else
            {
                ...
                if (file_exists("teacherimage/" . $_FILES["uploadedfile"]["name"]))
                {
                ...
                else
                {
                    ...
                    move_uploaded_file($_FILES["uploadedfile"]["tmp_name"], "teacherimage/" . $_FILES["uploadedfile"]["name"]);
