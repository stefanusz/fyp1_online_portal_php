...
{
    $backbutton = "<input type=button value='Go Back to Previous Page!' onclick='history.back(-1)' />";
    ...
    if (isset($_SESSION['email_add']))
    {
        ...
        $chooseprofile = "<a href='changepass.php'>Change password.</a></br/>
							<a href='profile.php'>Manage profile.</a></br/>";
    ...
    else
    {
        ...
        $chooseprofile = "<a href='changepass.php'>Change your password.</a></br/>
							<a href='profile.php'>Manage your profile.</a></br/>";
...
?>
                ...
                <div class="width75 floatRight"> 
                    ...
                    <div class="gradient"> <a name="fluidity"></a>
                        <h1>Please choose what do you want to do with your account below. </h1>
                        <br />
                        <br />
                        <p>
<?php
