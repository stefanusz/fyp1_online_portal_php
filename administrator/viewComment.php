...
// Make a MySQL Connection
                            ...
                            $query = "SELECT ROUND(AVG(rating),2) FROM comment WHERE teacher_id = '$teacherID'";
...
// Print out result
                            ...
                            {
                                echo "<h3>Average Rating for this teacher is " . $runrows['ROUND(AVG(rating),2)'] . " out of 10.</h3><br/>
            <br/>
            <input type=button value='Go to Previous page!' onclick='history.back(-1)' />";
                            ...
                            $sql = "SELECT rating, comment FROM comment WHERE teacher_id = '$teacherID'";
                            $query = mysqli_query($connect, $sql);

                            while ($runrows = mysqli_fetch_array($query))
                            {
                                $rating = $runrows['rating'];
                                $comment = $runrows['comment'];
