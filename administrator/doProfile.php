...
if ($_SESSION['role'] == 'teacher' || $_COOKIE['role'] == 'teacher')
{
    ...
    if ($submit)
    {
        ...
        if (isset($_SESSION['email_add']))
        {
            mysqli_query($connect, "UPDATE  `teacher`  SET `first_name` = '$first_name', `last_name` = '$last_name', `contact_no`='$contact_no', `rates`='$rates', `qualification` = '$qualification',`experience` = '$experience', `dob` = '$year-$month-$day' WHERE email_add = '$email_add' ") or die(mysql_error());
        }
        else if ($_COOKIE['email_add'])
        {
            mysqli_query($connect, "UPDATE  `teacher`  SET `first_name` = '$first_name', `last_name` = '$last_name', `contact_no`='$contact_no', `rates`='$rates', `qualification` = '$qualification',`experience` = '$experience', `dob` = '$year-$month-$day' WHERE email_add = '$email_add2' ") or die(mysql_error());
        }
...
if ($_SESSION['role'] == 'student' || $_COOKIE['role'] == 'student')
{
    if ($submit)
    {
        ...
        if (isset($_SESSION['email_add']))
        {
            mysqli_query($connect, "UPDATE  `registereduser`  SET `ic_number` = '$ic_number',`first_name` = '$first_name', `last_name` = '$last_name', `description` = '$description', `race` = '$race',`contact_no`='$contact_no', `nationality` = '$nationality', `dob` = '$year-$month-$day', WHERE email_add = '$email_add' ") or die(mysql_error());
        }
        else if ($_COOKIE['email_add'])
        {
            mysqli_query($connect, "UPDATE  `registereduser`  SET `ic_number` = '$ic_number',`first_name` = '$first_name', `last_name` = '$last_name', `description` = '$description', `race` = '$race',`contact_no`='$contact_no', `nationality` = '$nationality', `dob` = '$year-$month-$day', WHERE email_add = '$email_add2' ") or die(mysql_error());
        }
...
if ($_SESSION['role'] == 'admin' || $_COOKIE['role'] == 'admin')
{
    if ($submit)
    {
        ...
        if (isset($_SESSION['email_add']))
        {
            mysqli_query($connect, "UPDATE  `portalmanager`  SET `first_name` = '$first_name', `last_name` = '$last_name', `description` = '$description', `dob` = '$year-$month-$day', `postal_code` = '$postal_code', `ic_number` = '$ic_number' WHERE email_add = '$email_add' ") or die(mysql_error());
        }
        else if ($_COOKIE['email_add'])
        {
            mysqli_query($connect, "UPDATE  `portalmanager`  SET `first_name` = '$first_name', `last_name` = '$last_name', `description` = '$description', `dob` = '$year-$month-$day', `postal_code` = '$postal_code', `ic_number` = '$ic_number' WHERE email_add = '$email_add2' ") or die(mysql_error());
        }
