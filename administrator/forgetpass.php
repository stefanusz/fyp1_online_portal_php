...
// If logged in, users can't access this page. If not logged in, allow users to submit their email. 
if (isset($_SESSION['email_add']) || isset($_COOKIE['email_add']))
{
    $login = "You are already logged in. There is no way you could have forget your password <br/>
...
else
{
    ...
    $form2 =
            "
						 Email:
						 <form id=form1 method=post action=doforgetpass.php>
						 <input type='text' name ='email_add' id='email_add' /><br/><br/>
...
?>
                ...
                <div class="width75 floatRight"> 
                    ...
                    <div class="gradient"> <a name="fluidity"></a>
                        ...
                        <br />
                        <br />
                        <h2>Please type your registered email adress. We will send your new password to you. </h2>
