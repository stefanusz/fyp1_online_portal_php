...
<?php
// To let the user to be able to do a search from the whole database.
if (isset($_SESSION['email_add']) || isset($_COOKIE['email_add']))
{
    echo '<form action="dosearch.php" method="GET">
...
{
    echo "<p>You need to be a member to do this, please log-in or register</p>";
}
?>
                    </div>
