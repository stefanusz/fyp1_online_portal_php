...
if ($_SESSION['role'] == 'teacher' || $_COOKIE['role'] == 'teacher')
{
    ...
    mysqli_query($connect, "UPDATE `relation` SET status = 'active' WHERE registeruser_id = '$REGISTERUSER_ID' ") or die(mysql_error());



    $active = "You have successfully accept the request of the student";
    if ($_COOKIE['role'] == 'teacher')
    {
        $teachernav = "<li><a href=video.php title=Your List of Videos. >Video</a></li>";
    }
