        ...
        <div id="content"> 
            ...
            <div id="page"> 
                ...
                <div class="width75 floatRight"> 
                    <div class="gradient">
                        <h1> Welcome to Portal for the Learners and Teachers! (:</h1>
                        
                        <h3>
                            This website is all about you the students and teachers. You can both register as a Teacher or a Student. <br/>
                            As a teacher, this will give you a platform to share your knowledge and experiences to teach the student in your category specialty!<br/>
                            As a Student, this will give you an access to a lot of teacher and the kind of learning subject that you want!<br/>
                            So come join our website now ! 
                        </h3>
                    </div>
                    
                    <!-- Gives the gradient block -->
                    <div class="gradient"> <a name="fluidity"></a>
                        <h1>Our Latest Teacher Addition!</h1>
                        <p>
                            <?php
