...
if (isset($_SESSION['email_add']) || isset($_COOKIE['email_add']))
{
    if ($_SESSION['role'] == 'admin' || $_COOKIE['role'] == 'admin')
    {
        ...
        $h3tittle = "<h3>Please choose which one you want to do.</h3>";
        $portalmanager = "<h3><a href=addManager.php title='Add a Portal Manager' class=here>Add Portal Manager.</a></h3>";

        $editUser = "<h3><a href=edit.php title='Manager a User' class=here>Manage Users.</a></h3>";
    }
    else
    {
...
{
    $notlogin = "You are not logged in. Please log in, in order to use the features here. Thank you!";
}
?>
...
?>
                ...
                <div class="width75 floatRight"> 
                    ...
                    <div class="gradient"> <a name="fluidity"></a>
                        <h1>This is the Manage Tab!</h1>
                        <br />
                        <p> <?php echo $h3tittle; ?> <?php echo $portalmanager; ?> <?php echo $editUser; ?><?php echo $notlogin; ?> </p>
                        <p>&nbsp;</p>
                    </div>
