...
$videosql = "SELECT `link` FROM videos WHERE teacher_id = '$TEACHER_ID' ";

$query = mysqli_query($connect, $videosql);
?>
        ...
        <div id="content"> 
            ...
            <div id="page"> 
                ...
                <div class="width75 floatRight"> 
                    ...
                    <div class="gradient"> <a name="fluidity"></a>
                        <h1>Showing this teacher videos.</h1>
                        ...
                        <div class="width75 floatLeft">
                            ...
                            <p>
                                ...
                                if ($_SESSION['role']  || $_COOKIE['role'])
                                {
                                    ...
                                    $targetpage = "seeVideo.php";  //your file name  (the name of this file)
                                    ...
                                    /* Get data. */
                                    $sql = "SELECT `link` FROM videos WHERE teacher_id = '$TEACHER_ID' ORDER BY video_id DESC LIMIT $start, $limit";
                                    ...
                                    if ($lastpage > 1)
                                    {
                                        ...
                                        if ($page > 1)
                                        {
                                            $pagination.= "<a href=\"$targetpage?page=$prev&id=$TEACHER_ID\">« previous</a>";
                                        }
                                        else
                                        {
                                        ...
                                        if ($lastpage < 7 + ($adjacents * 2)) //not enough pages to bother breaking it up
                                        {
                                            for ($counter = 1; $counter <= $lastpage; $counter++)
                                            {
                                                if ($counter == $page)
                                                    ...
                                                    $pagination.= "<a href=\"$targetpage?page=$counter&id=$TEACHER_ID\">$counter</a>";
                                            }
                                        }
                                        elseif ($lastpage > 5 + ($adjacents * 2)) //enough pages to hide some
                                        {
                                            ...
                                            if ($page < 1 + ($adjacents * 2))
                                            {
                                                ...
                                                {
                                                    if ($counter == $page)
                                                        $pagination.= "<span class=\"current&search=$search&id=$TEACHER_ID\">$counter</span>";
                                                    else
                                                        $pagination.= "<a href=\"$targetpage?page=$counter&id=$TEACHER_ID\">$counter</a>";
                                                }
                                                $pagination.= "...";
                                            ...
                                            {
                                                $pagination.= "<a href=\"$targetpage?page=1&id=$TEACHER_ID\">1</a>";
                                                $pagination.= "<a href=\"$targetpage?page=2&id=$TEACHER_ID\">2</a>";
                                                $pagination.= "...";
                                                ...
                                                $pagination.= "...";
                                                $pagination.= "<a href=\"$targetpage?page=$lpm1&id=$TEACHER_ID\">$lpm1</a>";
                                                $pagination.= "<a href=\"$targetpage?page=$lastpage&id=$TEACHER_ID\">$lastpage</a>";
                                            }
                                        ...
                                        //next button
                                        if ($page < $counter - 1)
                                            $pagination.= "<a href=\"$targetpage?page=$next&id=$TEACHER_ID\">next »</a>";
                                        else
            ...
            <input type=button value='Back to previous page!' onclick='history.back(-1)' /><br/><br/>";
                                    ...
                                    while ($runrows = mysqli_fetch_array($result))
                                    {
                                        ...
                                        echo $videolink = "<iframe width=480 height=300 src=http://www.youtube.com/embed/$link frameborder=0 allowfullscreen></iframe><br/><br/><br/>";
                                    }
                                    echo $pagination;
                                }
