...
{
    $_SESSION = array();
    session_destroy(); //destroy previously stored cookies

    setcookie("email_add", "", time() - 60 * 60 * 24 * 10);
    setcookie("role", "", time() - 60 * 60 * 24 * 10);
    setcookie("first_name", "", time() - 60 * 60 * 24 * 10);
            ...
            <div id="page"> 
                ...
                <div class="width75 floatRight"> 
                    ...
                    <div class="gradient"> <a name="fluidity"></a>
                        ...
                        <br />
                        <br />
                        <h2>Thank you for using our website. We look forward to your next visit. </h2>
                        <br />
                        <br />
                        <p>
<?php
